				...
				if (opFlag) {
					...
					if (result != 1) {
						if (result == 0) {
							...
							Toast.makeText(LockGoogleViewActivity.this, "√‹¬Î¥ÌŒÛ", Toast.LENGTH_LONG).show();
						} else {
							lockPatternView.clearPattern();
							Toast.makeText(LockGoogleViewActivity.this, "«Î…Ë÷√√‹¬Î", Toast.LENGTH_LONG).show();
						}
					} else {
						Toast.makeText(LockGoogleViewActivity.this, "√‹¬Î’˝»∑", Toast.LENGTH_LONG).show();
					}
				} else {
					lockPatternUtils.saveLockPattern(pattern);
					Toast.makeText(LockGoogleViewActivity.this, "√‹¬Î“—æ≠…Ë÷√", Toast.LENGTH_LONG).show();
					lockPatternView.clearPattern();
				}
			}
