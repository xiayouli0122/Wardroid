package com.example.ward.view.progressbar;
...
public class CircleProgressBarDemo extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHoloCircularProgressBar.setThumbEnabled(true);
        ...
        mOne.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mHoloCircularProgressBar.setMarkerProgress(0.8f);
...
//        mHoloCircularProgressBar.setProgressBackgroundColor(randomColor);
        ...
        mHoloCircularProgressBar.setProgressBackgroundColor(Color.DKGRAY);
    }
