...
public class FullScreenTest extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
        ...
        {  
        case R.id.btn1:  
        	//显示状态栏(NotificationBar)，Activity不全屏显示(恢复到有状态的正常情况)  
            mRLayout.setSystemUiVisibility(View.SYSTEM_UI_FLAG_VISIBLE);      
            break;  
        case R.id.btn2:  
        	//隐藏状态栏(NotificationBar)，同时Activity会伸展全屏显示  
        ...
        case R.id.btn5:  
            //ͬThe Same as mRLayout.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);  
